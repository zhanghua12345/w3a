  ...
  <div class="page-account">
    <div class="container" :class="[fullWidth > 768 ? 'containerSamll' : 'containerBig']">
      <div class="page-login">
        <i class="iconfont el-icon-bangzhu" style="color: var(--prev-color-primary);font-size: 24px; ">&#xe677;</i>
        <div style="font-size: 20px; color: #000;margin-left: 16px;">Admin<span style="margin-left: 4px; color: var(--prev-color-primary)">PRO</span></div>
      </div>
      ...
      <el-card class="box-card" style="border-radius: 10px">
        <div class="index_from page-account-container from-wh">
          ...
          <h3 class="login-text" type="primary">登录</h3>
