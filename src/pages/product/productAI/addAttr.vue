  ...
  >
    ...
    >
      <el-row :gutter="24" :style="{ maxHeight: '600px', overflowY: 'auto' }">
        <el-col :span="16">
          <el-form-item label="AI问题" prop="title">
            <el-input placeholder="请输入AI问题" :maxlength="20" v-model.trim="formDynamic.title" />
          </el-form-item>
        </el-col>
        <el-col :span="16">
          <el-form-item label="AI描述" prop="dec">
            <el-input placeholder="请输入AI描述" :maxlength="20" v-model.trim="formDynamic.dec" />
          </el-form-item>
        </el-col>
        <el-col :span="16">
          <el-form-item label="AI类型" prop="type">
            <el-select v-model="formDynamic.type" placeholder="请选择AI类型" style="width: 100%">
              ...
              <el-option value="select" label="下拉框选择器" />
        ...
        <el-col :span="24" v-if="['select', 'radio'].includes(formDynamic.type)">
